...
public class Demonio extends Enemigo {
    ...
    public Demonio(int idEnemigo, String nombre, int vidaMaxima, double velocidad, int puntos) {
       ...
       /* int max = 600;
        int min = 287;
        posRandomX = (Math.random() * (max - min)) + min;*/
    ...
    /*private void fase3Boss() {
        ...
        if (fase3) {
            //DERECHA
            if (posicionX + 32 < posRandomX && !enColisionDerecha()) {
                posicionX += velocidad;
                direccion = 2;
            ...
            //IZQUIERDA
            if (posicionX + 32 > posRandomX && !enColisionIzquierda()) {
                posicionX -= velocidad;
                direccion = 1;
            }

            if (posicionX + 32 == posRandomX || posicionX - 32 == posRandomX) {
                direccion = 0;
            }
  ...
  /*  public double obtenerPosRandomX() {
        return posRandomX;
    }*/
